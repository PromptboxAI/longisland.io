...
export const SEED_MERCHANTS: AffiliateMerchant[] = [
  {
    ...
    brand_color: "#ffd814",
    brand_text_color: "#0f1111",
    brand_hover_color: "#f7ca00",
    status: "published",
    created_at: NOW,
    updated_at: NOW,
  },
  {
    id: "merch_tiktok_shop",
    name: "TikTok Shop",
    slug: "tiktok-shop",
    network: "tiktok_shop",
...
const OFFER_SEEDS: OfferSeed[] = [
  ...
  ["shorepoint-waterproof-speaker", "tiktok-shop", 109.0, "in_stock"],
  ["harborlight-rolling-beach-wagon", "tiktok-shop", 172.0, "in_stock"],
